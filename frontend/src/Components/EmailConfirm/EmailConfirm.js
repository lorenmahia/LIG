...
const EmailConfirm = () => {
    ...
    return (
        <>
            ...
            <div style={{ textAlign: 'center', display: 'flex', width: '100%', height: '100%', flexDirection: 'column', flexWrap: 'nowrap', alignItems: 'center', justifyContent: 'center', alignContent: 'center', marginTop: '100px' }}>
